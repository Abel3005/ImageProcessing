// Opencv_05.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	//옵티컬 플로우 수행
	calcOpticalFlowPyrLK(gray1, gray2, points1, points2, isFound,error, Size(5, 5), 3, TermCriteria(CV_TERMCRIT_ITER | CV_TERMCRIT_EPS, 20, .3));
